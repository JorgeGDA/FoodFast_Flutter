...
import 'constants/app_colors.dart'; // Importa tus colores
import 'constants/app_text_styles.dart'; // Importa tus estilos de texto
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: HomeScreen(cartService: cartService), // <-- Pasa cartService
